import { Button, ButtonIcon, ButtonText } from '@repo/ui'
...
export default function Home() {
  return (
    <div>
      <div className="bg-gradient-to-t from-spindle-900 to-spindle-500 px-6 py-5 flex flex-col gap-8 md:flex-row-reverse md:justify-between md:items-center">
        <img
        ...
        <div className="flex flex-col gap-4 md:grid md:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 12 }).map((_, i) => {
            return (
              <div
                key={i}
                className="flex flex-col gap-5 py-6 px-5 rounded-lg border border-spindle-100 shadow-lg transition-transform duration-300 hover:scale-[1.025]"
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-geyser-400 text-sm leading-base">
                      8/16
                    </span>
                  </div>
                </div>
